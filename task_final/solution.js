...
function sendRequest(name, phone, address, goods, sum) {
    ...
    allData.data.client = name + " " + phone;
    allData.data.order.address =  "ул. " + address.street + ", " + "дом " + address.house + ", " + address.entrance + " подъезд" + ", " + address.floor + " этаж" + ", " + "кв " + address.flat;
    allData.data.order.sum = sum;
